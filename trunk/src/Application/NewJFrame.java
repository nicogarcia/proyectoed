...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
        try {
            ...
            blue = ImageIO.read(getClass().getResource("/images/blue_node.png"));
            orange = ImageIO.read(getClass().getResource(
                    "/images/orange_node.png"));
            gray = ImageIO.read(getClass().getResource("/images/gray_node.png"));
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(17, 153));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnAddNode, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtRotulo, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                            .addComponent(cbPadres, 0, 56, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(174, 98));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnDeleteLevel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
        ...
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder("Mostrar altura"));
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblAltura, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addGroup(jPanel10Layout.createSequentialGroup()
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnLoadTree, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Grafico de recorrido"));
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Grafico"));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(210, 210, 210)
                .addComponent(radioArbol, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(radioNiveles, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                .addGap(226, 226, 226))
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addContainerGap()
        ...
        panelDeFondoLayout.setVerticalGroup(
            ...
            .addGroup(panelDeFondoLayout.createSequentialGroup()
                ...
                .addGroup(panelDeFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.LEADING, 0, 685, Short.MAX_VALUE)
    ...
    private void drawSelected(Point2D point, Graphics2D e) {
        if (arbol != null && !arbol.isEmpty()) {
            ...
            if (last_draw != null) {
                elipse = new Ellipse2D.Double(last_draw.getX(), last_draw.getY(), 48, 48);
                if (elipse.contains(point)) {
                    return;
                }
                dibujarNodo(green, last_draw, last_text, e);
            }
            try {
                for (Position<Character> pos : arbol.positions()) {
                    TNode<Character> nodo = (TNode<Character>) pos;
                    elipse = new Ellipse2D.Double(nodo.getCorner().getX(), nodo.getCorner().getY(), 48, 48);
                    if (elipse.contains(point)) {
                        String str = ((Integer) arbol.height(nodo)).toString();
                        dibujarNodo(red, nodo.getCorner(), str, e);
                        last_text = nodo.element().toString();
    ...
    private void dibujarNodo(Image dibujo, Point2D corner, String texto,
        ...
        e.drawString(texto, (int) (corner.getX() + 48 / 2 - 5), (int) (corner.getY() + 48 / 2 + 5));
    }
    ...
    private void btnAddNodeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddNodeActionPerformed
        if (!perteneceAlCombo(cbPadres, txtRotulo.getText().charAt(0))) {
            ...
            if (!txtRotulo.getText().equals("")) {
                ...
                TestingApplication.agregarNodo(nuevo, (Character) cbPadres.getSelectedItem());
                // TODO Revisar! Recalcula los centros de los nodos
                try {
                    TestingApplication.calcularCentros(mpdArbol.getWidth(),
                            new Point2D.Double(0, 20), (TNode<Character>) arbol.root());
    ...
    private void btnDeleteLevelActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteLevelActionPerformed
        try {
            pila_a_pintar = TestingApplication.eliminarNivel((Integer) cbNiveles.getSelectedItem());
            // TODO Revisar! Recalcula los centros de los nodos
            TestingApplication.calcularCentros(mpdArbol.getWidth(),
                    new Point2D.Double(0, 20), (TNode<Character>) arbol.root());
            actualizarCombo(cbPadres);
    ...
    public void graficarRecorrido(Graphics2D e) {
        ...
        if (arbol != null && !arbol.isEmpty()) {
            ...
            if (radioPre.isSelected()) {
                lista = (PositionList<Position<Character>>) arbol.preOrderPositions();
            } else {
                lista = (PositionList<Position<Character>>) arbol.posOrderPositions();
            }
                ...
                for (Position<Character> pos : arbol.positions()) {
                    ...
                    if (!arbol.isRoot(pos)) {
                        ...
                        centro = new Point2D.Double(nodo.getCorner().getX()
                                ...
                                + size.getHeight() / 2);
                        centropadre = new Point2D.Double(padre.getCorner().getX()
    ...
    private void resaltarCamino(Graphics2D e) {
        ...
        try {
            lista = TestingApplication.route((Character) cbDesde.getSelectedItem(), (Character) cbHasta.getSelectedItem());
            Line2D arco;
            Point2D centropadre;
            Point2D centro;
            ...
            while (!salir) {
                ...
                TNode<Character> nodo = (TNode<Character>) arbol.findNodo(pos.element());
                if (!last) {
                    TNode<Character> siguiente = (TNode<Character>) arbol.findNodo(lista.next(pos).element());
                    ...
                    centro = new Point2D.Double(nodo.getCorner().getX()
                            + size.getWidth() / 2, nodo.getCorner().getY()
                            + size.getHeight() / 2);
                    centropadre = new Point2D.Double(siguiente.getCorner().getX()
                ...
                e.setColor(Color.white);
                e.drawImage(blue, (int) nodo.getCorner().getX(), (int) nodo.getCorner().getY(), null);
                e.drawString(nodo.element().toString(), (int) (nodo.getCorner().getX()
                        + size.getWidth() / 2 - 5), (int) (nodo.getCorner().getY()
                        + size.getHeight() / 2 + 5));
                if (!last) {
    ...
    private void resaltarAncestro(Graphics2D e) {
        ...
        try {
            nodo = (TNode<Character>) arbol.findNodo(TestingApplication.ancestroComun((Character) cbDesde.getSelectedItem(),
                    (Character) cbHasta.getSelectedItem()));

            e.setColor(Color.white);
            e.drawImage(orange, (int) nodo.getCorner().getX(), (int) nodo.getCorner().getY(), null);
            e.drawString(nodo.element().toString(), (int) (nodo.getCorner().getX()
                    + size.getWidth() / 2 - 5), (int) (nodo.getCorner().getY()
                    + size.getHeight() / 2 + 5));
        } catch (InvalidPositionException e1) {
    ...
    public void graficarNiveles(Graphics2D e) {
        ...
        if (arbol != null && !arbol.isEmpty()) {
            ...
            for (Position<Character> pos : arbol.listadoNiveles().positions()) {
                if (nivel == 1) {
                    e.drawImage(green, margentxt + anchotxt,
                            renglon - 32, null);
